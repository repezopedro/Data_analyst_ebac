# -*- coding: utf-8 -*-
"""Profissao Analista de dados M5 Exercicio.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1DUzoS80S3pcAtmPt-v776FvSIdfhJ0ka
...
valor_emprestimos_lista_filtrada = list(filter(lambda numero: numero > 0, valor_emprestimos_lista))
...
desvio_padrao = reduce(lambda x, y: x + (y - sum(valor_emprestimos_lista_filtrada) / len(valor_emprestimos_lista_filtrada)) ** 2, valor_emprestimos_lista_filtrada, 0) / (len(valor_emprestimos_lista_filtrada) - 1)
desvio_padrao_valor_emprestimos = (desvio_padrao) ** 0.5
